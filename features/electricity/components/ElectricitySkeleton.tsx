...
export function ElectricitySummaryCardsSkeleton() {
  return (
...
export function ElectricityChartSkeleton() {
  return (
...
export function ConsumptionHistorySkeleton() {
  return (
    <View className="gap-2">
      {Array.from({ length: 3 }).map((_, i) => (
        <View key={i} className="h-16 w-full rounded-lg bg-muted" />
      ))}
    </View>
  );
}
