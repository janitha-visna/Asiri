...
function PointerLabel({
  ...
  if (!item) return null;
  return (
    <View className="min-w-[130px] items-center gap-0.5 rounded-lg bg-foreground px-3 py-2 shadow-md">
...
export function RevenueAnalyticsLineChart({
  response,
}: {
